...
x0 = np.array([1, 1, 1])
# matriz de iteração
C = np.array([ [0, 2/3, -1/3], [4, 0, 7], [1/5, 0, 0] ] )
# vetor de deslocamento
g = np.array([7/3, -2, -1/5])

x1 = C @ x0 + g
E1 = norm(x1 - x0) / norm(x1)
print(E1)

x2 = C @ x1 + g
E2 = norm(x2 - x1) / norm(x2)
print(E2)

x3 = C @ x2 + g
E3 = norm(x3 - x2) / norm(x3)
print(E3)

x4 = C @ x3 + g
E4 = norm(x4 - x3) / norm(x4)
print(E4)
...
C = np.array([ [0, 2/3, -1/3], [1/4, 0, 7/34], [1/5, 0, 0] ] )
norm(C)
